                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row" >
                                                ...
                                                <div class="form-group col-md">
                                                    ...
                                                    <input class="form-control" type="number" name="txtTel" placeholder="Nro. Teléfono"  required="" id="txtTelefono" autocomplete="off">
                                                </div>
                                            </div> 
                                            <div class="form-group">
                                                <label for="txtDireccion">Direccion: </label>
                                                <input class="form-control" type="text" name="txtDir" placeholder="Dirección"  id="txtDireccion" required="" autocomplete="off">
                                            </div>
                                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover" >
                                    ...
                                    <%
                                        ...
                                        List<beanProveedor> lstProv = dProv.listar();
                                        Iterator<beanProveedor> iter = lstProv.iterator();
                                    ...
                                    <tbody>
                                        <tr>                                            
                                            <td><%= bProv.getNombre()%></td>
                                            <td><%= bProv.getRuc()%></td>
                                            <td><%= bProv.getTelefono()%></td>
                                            <td><%= bProv.getDireccion_provedor()%></td>
                                            <td>
                                                <div class="btn-group" >
                                                    <a  class="btn btn-primary" href="Controlador?accion=editar&id=<%= bProv.getId_Provedor()%>">
